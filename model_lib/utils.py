...
GlobalParams = collections.namedtuple('GlobalParams', [
    ...
    'attn_ratio', 'mlp_ratio', 'attn_drop', 'proj_drop',
    'qkv_bias', 'is_concat', 'is_scale',
...
def efficientnet(width_coefficient=None, depth_coefficient=None, image_size=None,
                 attn_ratio=None, mlp_ratio=None, attn_drop=0.0, proj_drop=0.0,
                 qkv_bias=False, is_concat=True, is_scale=False,
