...
def get_norm_act_layer(norm_layer, act_layer=None, g=None):
    ...
    if isinstance(norm_layer, str):
        ...
        if type_name.startswith('batchnorm'):
            ...
            if g == None:
                ...
                norm_act_layer = functools.partial(GroupNormAct, num_groups=g)
        ...
        # elif type_name.startswith('groupnorm2'):
        #     norm_act_layer = functools.partial(GroupNormAct, num_groups=2)
        # elif type_name.startswith('layernorm2d'):
        #     norm_act_layer = LayerNormAct2d
        # elif type_name.startswith('layernorm'):
        #     norm_act_layer = LayerNormAct
